...
gear.gada_enhancing_club = {
    name = "Gada",
    augments = {
        'Enh. Mag. eff. dur. +6', 'STR+3', 'Mag. Acc.+8', '"Mag.Atk.Bns."+17',
        'DMG:+7'
    }
}
gear.gada_healing_club = {
    name = "Gada",
    augments = {
        '"Cure" potency +9%', 'Mag. Acc.+11', '"Mag.Atk.Bns."+13', 'DMG:+3'
    }
}
gear.grioavolr_nuke_staff = {
    name = "Grioavolr",
    augments = {
        'Magic burst dmg.+8%', 'MP+61', 'Mag. Acc.+16', '"Mag.Atk.Bns."+30',
        'Magic Damage +7'
    }
}
gear.grioavolr_fc_staff = {
    name = "Grioavolr",
    augments = {
        '"Fast Cast"+7', 'MP+20', 'Mag. Acc.+17', '"Mag.Atk.Bns."+10',
        'Magic Damage +5'
    }
}
gear.grioavolr_pet_staff = {
    name = "Grioavolr",
    augments = {
        'Blood Pact Dmg.+8', 'Pet: STR+10', 'Pet: Mag. Acc.+19',
        'Pet: "Mag.Atk.Bns."+30'
    }
}
...
gear.chironic_refresh_hands = {
    name = "Chironic Gloves",
    augments = {
        '"Counter"+4', 'DEX+4', '"Refresh"+2', 'Accuracy+19 Attack+19',
...
gear.chironic_nuke_feet = {
    name = "Chironic Slippers",
    augments = {
        'Mag. Acc.+25 "Mag.Atk.Bns."+25', '"Drain" and "Aspir" potency +10',
        'CHR+6', '"Mag.Atk.Bns."+15'
    }
}
gear.chironic_refresh_feet = {
    name = "Chironic Slippers",
    augments = {
        'Pet: Attack+23 Pet: Rng.Atk.+23', 'Pet: Haste+1', '"Refresh"+2',
...
gear.herculean_nuke_head = {
    name = "Herculean Helm",
    augments = {
        'Mag. Acc.+16 "Mag.Atk.Bns."+16', 'Enmity-3', 'INT+9',
        '"Mag.Atk.Bns."+13'
    }
}
...
gear.herculean_phalanx_hands = {
    name = "Herculean Gloves",
    augments = {
        'Pet: DEX+15', 'Sklchn.dmg.+1%', 'Phalanx +2',
        'Accuracy+6 Attack+6', 'Mag. Acc.+14 "Mag.Atk.Bns."+14'
    }
}
gear.herculean_treasure_hands = {
    name = "Herculean Gloves",
    augments = {
        '"Store TP"+7', 'INT+6', '"Treasure Hunter"+2', 'Accuracy+17 Attack+17',
...
gear.herculean_wsd_legs = {
    name = "Herculean Trousers",
    augments = {
        '"Store TP"+4', 'Accuracy+10', 'Weapon skill damage +8%',
        'Accuracy+9 Attack+9', 'Mag. Acc.+11 "Mag.Atk.Bns."+11'
    }
}
gear.herculean_nuke_legs = {
    name = "Herculean Trousers",
    augments = {
        'Mag. Acc.+18 "Mag.Atk.Bns."+18', 'Damage taken-2%', '"Mag.Atk.Bns."+14'
    }
}
gear.herculean_acc_feet = {
    name = "Herculean Boots",
    augments = {
        'Accuracy+25 Attack+25', 'Crit. hit damage +1%', 'DEX+10',
        'Accuracy+14', 'Attack+1'
    }
}
gear.herculean_ta_feet = {
    name = "Herculean Boots",
    augments = {
        'Pet: STR+2', 'MND+10', 'Phalanx +1', 'Accuracy+18 Attack+18',
...
gear.merlinic_nuke_head = {
    name = "Merlinic Hood",
    augments = {
        'Mag. Acc.+21 "Mag.Atk.Bns."+21', 'INT+15', 'Mag. Acc.+3',
        '"Mag.Atk.Bns."+13'
    }
}
gear.merlinic_nuke_body = {
    ...
    augments = {
        'Mag. Acc.+22 "Mag.Atk.Bns."+22', '"Occult Acumen"+4', 'INT+10',
        'Mag. Acc.+2', '"Mag.Atk.Bns."+15'
    }
}
...
gear.merlinic_refresh_hands = {
    ...
    augments = {
        'Attack+17', 'Pet: INT+5', '"Refresh"+2', 'Accuracy+11 Attack+11'
    }
}
gear.merlinic_magpact_hands = {
    name = "Merlinic Dastanas",
    augments = {
        'Pet: Mag. Acc.+27', 'Blood Pact Dmg.+10', 'Pet: DEX+8',
        'Pet: "Mag.Atk.Bns."+13'
    }
}
gear.merlinic_physpact_hands = {
    name = "Merlinic Dastanas",
    augments = {
        'Pet: Accuracy+28 Pet: Rng. Acc.+28', 'Blood Pact Dmg.+10',
        'Pet: STR+7', 'Pet: Mag. Acc.+6'
    }
}
...
gear.merlinic_nuke_feet = {
    ...
    augments = {
        'Mag. Acc.+19 "Mag.Atk.Bns."+19', '"Conserve MP"+1', 'INT+11',
        'Mag. Acc.+3', '"Mag.Atk.Bns."+15'
    }
}
gear.merlinic_aspir_feet = {
    name = "Merlinic Crackows",
    augments = {
        'Mag. Acc.+22 "Mag.Atk.Bns."+22', '"Drain" and "Aspir" potency +10',
        'Mag. Acc.+15'
    }
}
gear.merlinic_treasure_feet = {
    name = "Merlinic Crackows",
    augments = {
        'Accuracy+5', '"Snapshot"+2', '"Treasure Hunter"+2',
...
gear.merlinic_refresh_feet = {
    name = "Merlinic Crackows",
    augments = {
        'Pet: DEX+7', 'Pet: Mag. Acc.+7', '"Refresh"+2', 'Accuracy+20 Attack+20'
    }
}
...
gear.valorous_wsd_head = {
    name = "Valorous Mask",
    augments = {
        'Accuracy+10 Attack+10', 'Weapon skill damage +4%', 'STR+4', 'Attack+10'
    }
}
gear.valorous_pet_head = {
    name = "Valorous Mask",
    augments = {
        'Pet: "Mag.Atk.Bns."+25', 'Pet: "Regen"+3', 'Pet: INT+14',
        'Pet: Accuracy+2 Pet: Rng. Acc.+2'
    }
}
gear.valorous_pet_body = {
    name = "Valorous Mail",
    augments = {
        'Pet: "Mag.Atk.Bns."+26', '"Dbl.Atk."+3', 'Pet: INT+8',
        'Pet: Accuracy+13 Pet: Rng. Acc.+13', 'Pet: Attack+12 Pet: Rng.Atk.+12'
    }
}
gear.valorous_wsd_body = {
    name = "Valorous Mail",
    augments = {
        'Accuracy+25 Attack+25', 'Weapon skill damage +4%', 'Accuracy+10',
        'Attack+12'
    }
}
...
gear.valorous_acc_hands = {
    name = "Valorous Mitts",
    augments = {
        'Accuracy+21 Attack+21', '"Store TP"+4', 'Accuracy+15', 'Attack+9'
    }
}
gear.valorous_physical_pet_legs = {
    name = "Valor. Hose",
    augments = {
        'Pet: Attack+29 Pet: Rng.Atk.+29',
        'Pet: "Dbl.Atk."+3 Pet: Crit.hit rate +3', 'Pet: STR+8',
...
gear.valorous_magical_pet_legs = {
    name = "Valor. Hose",
    augments = {
        'Pet: "Mag.Atk.Bns."+28', 'Pet: "Regen"+3', 'Pet: INT+13',
...
gear.valorous_magical_pet_feet = {
    ...
    augments = {
        'Pet: "Mag.Atk.Bns."+29', 'Pet: "Dbl.Atk."+1 Pet: Crit.hit rate +1',
        'Pet: INT+9', 'Pet: Accuracy+1 Pet: Rng. Acc.+1',
