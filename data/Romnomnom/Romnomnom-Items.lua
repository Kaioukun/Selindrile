...
gear.herculean_phalanx_hands = {
    name = "Herculean Gloves",
    augments = {
        'INT+6', 'MND+7', 'Phalanx +4', 'Accuracy+10 Attack+10',
        'Mag. Acc.+13 "Mag.Atk.Bns."+13'
    }
}
...
gear.herculean_ta_feet = {
    name = "Herculean Boots",
    augments = {
        'Accuracy+19 Attack+19', '"Triple Atk."+4', 'DEX+5', 'Accuracy+8',
        'Attack+11'
    }
}
...
gear.herculean_wsd_feet = {
    name = "Herculean Boots",
    augments = {
        'Accuracy+23 Attack+23', 'Weapon skill damage +5%', 'DEX+10',
        'Accuracy+10', 'Attack+1'
    }
}
...
gear.herculean_nuke_feet = {
    name = "Herculean Boots",
    augments = {
        '"Mag.Atk.Bns."+23', 'Rng.Acc.+14', 'Phalanx +1',
