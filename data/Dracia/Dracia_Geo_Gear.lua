function user_job_setup()
    ...
    gear.idle_jse_back = {
        name = "Nantosuelta's Cape",
        augments = {'HP+60', 'Eva.+20 /Mag. Eva.+20', 'Pet: "Regen"+10'}
    }
...
function init_gear_sets()
    ...
    sets.midcast.Geomancy = {
        ...
        range = "Dunna",
        head = "Azimuth Hood",
        neck = "Melic Torque", -- neck = "Incanter's Torque",
        ear1 = "Gifted Earring",
        -- ear2 = "Malignance Earring",
        body = "Bagua Tunic +1",
    ...
    sets.midcast.MndEnfeebles.Resistant =
        set_combine(sets.midcast['Enfeebling Magic'].Resistant,
                    {range = empty, ring1 = "Stikini Ring"})
...
function select_default_macro_book() set_macro_page(4, 10) end
